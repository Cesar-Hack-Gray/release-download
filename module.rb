...
class Msf::Payload::Apk
  ...
  def print_status(msg='')
    $stderr.puts "\033[1;34m[*]\033[1;37m #{msg}"
  end
  ...
  def backdoor_apk(apkfile, raw_payload)
    ...
    run_cmd("CHG d #{tempdir}/original.apk -o #{tempdir}/original")
    print_status "Decompiling payload APK..\n"
    run_cmd("CHG d #{tempdir}/payload.apk -o #{tempdir}/payload")
    ...
    apktool_output = run_cmd("CHG b -a /usr/bin/aapt #{tempdir}/original -o #{tempdir}/output.apk")
