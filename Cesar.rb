...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
    ...
    print_status "Nota, Hola soy Cesar Hack Gray, esta herramienta es multi payloads disfrutala y no me ago responsable del mal uso ok (backdooring)"
    print_status "Spayer y Spade son mis herramientas att.. Cesar"
    ...
    run_cmd("cp #{tempdir}/output.apk $HOME/Spayer/originales")
